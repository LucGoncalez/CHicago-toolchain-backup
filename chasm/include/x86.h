...
// Last edited on December 31 of 2018, at 13:26 BRT
...
#define NODE_TYPE_POINTER (NODE_TYPE_LABEL + 0x02)
#define NODE_TYPE_REGISTER (NODE_TYPE_LABEL + 0x03)
#define NODE_TYPE_INSTRUCTION (NODE_TYPE_LABEL + 0x04)
...
#define INSTR_TYPE_POINTER 0x800
...
#define INSTR_ARG_POINTER 0x100
#define INSTR_ARG_MODRM_REG 0x200
#define INSTR_ARG_MODRM_ADDR 0x400
#define INSTR_ARG_MODRM_DISP 0x800
#define INSTR_ARG_MODRM_MULT 0x1000
#define INSTR_ARG_MODRM (INSTR_ARG_MODRM_REG | INSTR_ARG_MODRM_ADDR | INSTR_ARG_MODRM_DISP | INSTR_ARG_MODRM_MULT)
